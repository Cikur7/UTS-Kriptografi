...
if __name__ == "__main__":
    ...
    encrypted_image = process_image('/content/sikadu.jpg', key, '/content/sikadu_encrypted.jpg', mode='encrypt')
    print(f"Image encrypted: {encrypted_image}")

    # Image decryption
    print("Starting image decryption")
    decrypted_image = process_image("/content/sikadu_encrypted.png", key, '/content/sikadu_decrypted.png', mode='decrypt')
